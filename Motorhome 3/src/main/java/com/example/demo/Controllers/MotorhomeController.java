...
public class MotorhomeController {
    ...
    public String updateCustomer(Model model, int id){
        model.addAttribute("motorhomeupdate", motorhomeRepository.read(id));
    ...
    @GetMapping("/RegisterrentalAllMotorhomes")
    public String registerRental (Model model) {
        model.addAttribute("motorhomes", motorhomeRepository.readAll());


        return ("RegisterrentalAllMotorhomes");
    }
